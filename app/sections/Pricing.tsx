...
export  function Pricing(){
    return (
        <div className ="bg-[rgba(21,26,33,255)] flex flex-col justify-center items-center px-4 md:px-[8rem] md:pb-20  ">
            ...
            <div className="grid py-4 mt-8 grid-cols-4"> 
                <div className="border border-slate-600 flex flex-col justify-center items-center p-4 rounded-xl bg-[#1e252f]"> 
